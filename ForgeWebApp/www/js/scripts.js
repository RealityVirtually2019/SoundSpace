...
$(document).ready(function () {
    ...
    //(Adam) get my own variables to manipulate
    var AuthTokenForArVr;
    // var UrnForArVr;
    ...
    if (callback) {
        $.ajax({
            ...
            success: function (data) {
                ...
                //(Adam) SETTING the token.. send this to the front of the screen..
                AuthTokenForArVr = MyVars.token3Leg;
                // console.log('AR/VR Auth Token: ' + AuthTokenForArVr);
...
//(Adam) use button to get new token..
// function getTokenForArVr()
// {
//     get3LegToken();
// }
            ...
            'data': {
                ...
                "success": function (nodes) {
                    nodes.forEach(function (n) {
                        ...
                        //(Adam) Get their urn and token and display them on the front end.
                        // throw urn to the front
                        // can throw the token to the front once in a different 
                        // console.log("URN FOR AR VR:**************");
                        // console.log(UrnForArVr);
...
function initializeViewer(urn) {
    ...
    //(Adam) Throw up the urn and token here.... options.
    console.log("AR/VR Urn");
    console.log(urn);

    console.log("AR/VR Token");
    console.log(AuthTokenForArVr);
